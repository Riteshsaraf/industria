  ...
  const [project, setProjects] = useState([]);
    ...
    const handleUpload = async (f:any) => {
        ...
        try {
            ...
            setMessage(`${allRecords.length} project imported successfully`);
    ...
    async function loadProjects(pg=1) {
        try {
            setLoading(true);
            const res = await fetch(`/api/project/list?page=${pg}&pageSize=${pageSize}`);
    ...
    <div className="flex min-h-screen h-screen">
          ...
          <main className="flex-1 bg-gray-100 p-6  ">
             <div className="flex items-center justify-between mb-4">
                  <h1 className="text-[18px] font-semibold mb-4">project</h1>
